    ...
    <script>
        $(function(){
            ...
            $('#confirm').click(function(){
                ...
                window.location.href = "/c/user/center/${user1.userId!}";
            })
            ...
            $("#BUY").click(function(){
                ...
                if(payType == ${WeChatPay}){
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/c/order/wineYuEPay/'+orderId,
                        data: {
                            voucherId:voucherId
                        },
                        dataType: 'json',
...
<body class="body_3">
  ...
  <div class="goumaijq_1"><span>酒费（¥）</span><span><c style="color:#ff5901;font-size:0.26rem;margin-left:0.1rem;">${price!}</c></span></div>
