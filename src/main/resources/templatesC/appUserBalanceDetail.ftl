    ...
    <script>
        $(function(){
            $('.user_12_1').click(function(){
                ...
                location.href="/c/user/balanceDetail/"+status;
...
<body class="body_1">
<div class="header"> <img onclick=window.location.href="/c/user/userBalance/" src="/images/27.png"><span>明细</span> </div>
<div class="user_12">
