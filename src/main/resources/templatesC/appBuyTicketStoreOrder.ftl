 ...
 <script>
     $(function(){
         ...
         $('#confirm').click(function(){
             ...
             window.location.href = "/c/store/detail/${store.storeId}";
         })
...
<div class="goumaijq_1"><span>适用门店</span><span>${(store.storeName)!}</span></div>
<div class="goumaijq_1"><span>购买量（ml）</span><span>${(num)!}</span></div>
<div class="goumaijq_1"><span>酒费（¥）</span><span>${(price)!}</span></div>
...
<div class="goumaijq_1"><span>会员结算比列</span><span>${ratios!}%</span></div>
