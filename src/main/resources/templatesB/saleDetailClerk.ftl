...
<body class="body_1">
  <div class="header"><img onclick=window.location.href="/store/updateClerkPage/${clerkId!}" src="/images/27.png"><span>销售明细</span><span class="aaa">过滤</span></div>
    ...
    <div class="user_19_2">
          <#if clerks?exists>
              <#list clerks as clerk>
                  <div <#if '${clerkId!}'='${clerk.userId!}'>
                          class="user_19_3 checked_1"
                        <#else>
                          class="user_19_3"
                         </#if>>
                      <img src='/images/duihao.png' <#if '${clerkId!}'='${clerk.userId!}'>style="display:block;"</#if>>${clerk.userName!}
                      <input type="checkbox" style="display: none" name="clerk" value="${clerk.userId!}"
                             <#if '${clerkId!}'='${clerk.userId!}'>checked="checked"</#if>
                      />
